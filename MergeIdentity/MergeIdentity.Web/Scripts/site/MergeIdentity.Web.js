...
(function (MergeIdentity) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return MergeIdentity.LanguageList.getValue();
            };
    ...
    })(Northwind = MergeIdentity.Northwind || (MergeIdentity.Northwind = {}));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(MergeIdentity.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(MergeIdentity.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (MergeIdentity) {
    ...
    })(Common = MergeIdentity.Common || (MergeIdentity.Common = {}));
})(MergeIdentity || (MergeIdentity = {}));
...
(function (MergeIdentity) {
    ...
    (function (Northwind) {
        ...
        }(MergeIdentity.Common.GridEditorDialog));
...
(function (MergeIdentity) {
    ...
    (function (Northwind) {
        ...
        }(MergeIdentity.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new MergeIdentity.BasicProgressDialog();
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        }(MergeIdentity.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = MergeIdentity.BasicSamples || (MergeIdentity.BasicSamples = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(MergeIdentity.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: MergeIdentity.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                MergeIdentity.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (MergeIdentity) {
    ...
    })(Membership = MergeIdentity.Membership || (MergeIdentity.Membership = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var Membership;
...
(function (MergeIdentity) {
    ...
    })(ScriptInitialization = MergeIdentity.ScriptInitialization || (MergeIdentity.ScriptInitialization = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var Common;
...
(function (MergeIdentity) {
    ...
    })(Administration = MergeIdentity.Administration || (MergeIdentity.Administration = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var Administration;
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return MergeIdentity.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = MergeIdentity.BasicSamples || (MergeIdentity.BasicSamples = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
...
(function (MergeIdentity) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'MergeIdentity.Northwind.Entities.Gender');
    })(Northwind = MergeIdentity.Northwind || (MergeIdentity.Northwind = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
...
(function (MergeIdentity) {
    ...
    MergeIdentity.BasicProgressDialog = BasicProgressDialog;
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var DialogUtils;
    ...
    })(DialogUtils = MergeIdentity.DialogUtils || (MergeIdentity.DialogUtils = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var Common;
...
(function (MergeIdentity) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = MergeIdentity.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = MergeIdentity.LanguageList || (MergeIdentity.LanguageList = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var Common;
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return MergeIdentity.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return MergeIdentity.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return MergeIdentity.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        }(MergeIdentity.Northwind.ProductGrid));
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = MergeIdentity.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(MergeIdentity.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new MergeIdentity.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new MergeIdentity.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new MergeIdentity.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, MergeIdentity.Northwind.OrderRow.Fields.ShipCountry);
        ...
        }(MergeIdentity.Northwind.OrderGrid));
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return MergeIdentity.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return MergeIdentity.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return MergeIdentity.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return MergeIdentity.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = MergeIdentity.Northwind.ProductRow.Fields;
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        }(MergeIdentity.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return MergeIdentity.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        }(MergeIdentity.Northwind.OrderDetailsEditor));
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return MergeIdentity.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return MergeIdentity.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return MergeIdentity.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return MergeIdentity.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new MergeIdentity.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = MergeIdentity.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(MergeIdentity.Northwind.OrderDetailDialog));
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return MergeIdentity.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return MergeIdentity.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return MergeIdentity.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return MergeIdentity.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return MergeIdentity.Northwind.OrderService.baseUrl; };
...
(function (MergeIdentity) {
    ...
    (function (BasicSamples) {
        ...
        }(MergeIdentity.Northwind.OrderDialog));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: MergeIdentity.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: MergeIdentity.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new MergeIdentity.Northwind.OrderDialog();
                        ...
                        var chai = MergeIdentity.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = MergeIdentity.Northwind.EmployeeRow.getLookup().items
...
(function (MergeIdentity) {
    ...
    })(Authorization = MergeIdentity.Authorization || (MergeIdentity.Authorization = {}));
})(MergeIdentity || (MergeIdentity = {}));
var MergeIdentity;
(function (MergeIdentity) {
    var Administration;
...
//# sourceMappingURL=MergeIdentity.Web.js.map